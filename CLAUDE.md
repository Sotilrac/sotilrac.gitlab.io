...
- **Layouts**: `_includes/layouts/` (base, home, post, page, plain), all extend `base.njk`
...
Content is CC BY-NC-SA 4.0. `robots.txt` blocks AI training crawlers; `llms.txt` declares the license for LLMs.
