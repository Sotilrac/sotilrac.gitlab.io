    ...
    const y = "data-",
      ...
      C = (t, e, a) => {
        a &&
          ("function" == typeof X && X(),
          (Z = Y),
          (Y = D(new URL(a, o.href).toString())),
          Y !== Z && I && setTimeout(F, B));
      },
      J = () =>
        et ||
        !S ||
      ...
      z = () => {
        tt ||
          ...
          (() => {
            ...
            ((s.pushState = t(s, "pushState", C)),
              (s.replaceState = t(s, "replaceState", C)));
          })(),
          (() => {
            const t = async (t) => {
      ...
      G = (t, e) => (
        "string" == typeof t && (V = t),
        (Q = ""),
        q({ ...W(), data: "object" == typeof t ? t : e }, "identify")
      ),
      H = () => {
        const e = {};
        let a,
        ...
        (s("navigation", (t) => {
          ((i = t.activationStart || 0),
            (e.ttfb = Math.max(t.responseStart - i, 0)));
        }),
          s("paint", (t) => {
            "first-contentful-paint" === t.name &&
              (e.fcp = Math.max(t.startTime - i, 0));
          }),
              ...
              ((() => {
                if (r) {
                  if (void 0 === e.ttfb) {
                    ...
                    t &&
                      (e.ttfb = Math.max(
                        t.responseStart - (t.activationStart || 0),
                        0,
                      ));
                  }
                  if (void 0 === e.fcp) {
                    const t = l("paint")?.find(
                      (t) => "first-contentful-paint" === t.name,
                    );
