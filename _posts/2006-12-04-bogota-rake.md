...
{# {% fig "bogota closeup.jpg", "" %} - image lost #}
...
I accidentally broke my bristle. With the broken piece I built a tension wrench. it is a bit short, but it works well. If you want one, just bend the bristle (not too much or you may snap it).

{# {% fig "tension wrench.jpg", "" %} - image lost #}
