...
As a robotics engineer, I knew nothing about jewelry, or engagements, for that matter. I figured, "How hard can it be?". After all, it's simply manufacturing something, and I have over a year to figure this out.
...
From my side, I was very intrigued by the geometry of [tension-set rings](https://en.wikipedia.org/wiki/Tension_ring). No prongs, just the band itself holding the stone through spring force. Beautiful _and_ functional. Since this ring is meant to be worn forever, it also had to be durable, comfortable, and snag-free. Traditional prong designs look like they're going to catch on every pocket and sweater in existence.
...
I needed a precise 3D model of the actual sapphire I was going to use. The vendor's website had an interactive 3D viewer of the stone, but getting the actual model file was an extra cost I wasn't about to pay. So I pulled up Firefox dev tools, downloaded the SRN file backing the viewer, and reverse-engineered the format. SRN is a proprietary format from [Sarine Technologies](https://sarine.com/) used for gemstone scanning data, and there was no existing tool to extract the 3D mesh from it.

So I wrote one: [srn-parser](https://pypi.org/project/srn-parser/), a Python library that parses SRN files and extracts the 3D model.

## Jewelry CAD

It turns out "jewelry CAD" is an actual job title. After spending too long trying to learn [Blender](https://www.blender.org/) subdivision modeling myself, I posted a job on Upwork and hired two separate jewelry CAD designers. I combined their work by feeding inspiration from one into the other; mostly late at night after she would fall asleep.
...
I ordered the rose gold 3D print from Shapeways. When the printed band arrived, the sapphire fit flawlessly! The size was right (coincidentally the same diameter as my engineering ring). It looked amazing, even in plastic.
...
I finally dropped the ring components off at a local jeweler for the final stone setting, engraving and polish.

## The Proposal

The ring was ready one day before her birthday. I called the restaurant and we came up with a plan: bring the ring inside a glass of champagne at the beginning of the meal. They were very excited. I was ~~extremely excited~~ panicking.

The next day, I biked 40 minutes to pick up the ring. The jeweler wasn't available for another hour, so I parked by the seaport and spent an hour just sitting there. Breathing. Taking stock of everything that led to this moment.
...
- [band_hers.stl](/img/blog/hold-me-tight/band_hers.stl): ~~her wedding band~~ actually we ended up changing the design of this one.
- [band_his.stl](/img/blog/hold-me-tight/band_his.stl): his wedding band (the first ring i printed, mostly an experiment that just worked on the first try)
