...
I have always been interested in building and modifying things. As a child, I disassembled (or broke according to some) many of my toys in order to investigate how they worked. Very often, I was not capable of assembling them back again, so I used the pieces to build some other rudimentary toys.

Since then, I have considerably evolved. As a grown and responsible man, I disassemble many pieces of hardware, ranging from computer peripherals to household appliances, in order to learn how they function and to use the parts to build rudimentary machines. Fortunately for my loved ones, I don't experiment on new equipment: my primary source of hardware is the garbage.

This site is a diary of my creations. It serves two main goals: to organize my thoughts by making an inventory of what I have done, and to instruct an eventual reader on how to build these creations.
