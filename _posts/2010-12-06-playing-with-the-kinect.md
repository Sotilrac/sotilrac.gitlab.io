...
Nevertheless, I got a Kinect and [libfreenect and the entire OpenKinect project](http://openkinect.org) is awesome. The possibilities that the Kinect offers are boundless, whether it is used for robotics, human-computer interaction, 3d scanning, etc.
