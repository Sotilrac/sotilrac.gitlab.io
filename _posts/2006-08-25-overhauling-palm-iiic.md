...
{% fig "/img/blog/overhauling-palm-iiic/palm-craddle.jpg", "Palm Craddle" %}
...
{% fig "/img/blog/overhauling-palm-iiic/stylus.0.jpg", "Stylus" %}
...
The soft wood we used is perfect since it doesn't scratch the screen, we got it from a construction kit bought at the 1$ store.

## The Case

Using electric tape in the inside and crazy glue in the outside I repaired the case. Since the bottom screws were missing and the screw holes were broken, I drilled through the case (and the Cucaracha Negra PCB) where the original holes were in order to put some screws of my own.

## The End Result

{% fig "/img/blog/overhauling-palm-iiic/palm-iiic.0.jpg", "Palm IIIc" %}
