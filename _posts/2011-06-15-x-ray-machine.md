...
{% fig "IMG_0224.jpg", "The X-Ray Machine is watching You" %}
...
I also found what seems to be a very heavy base but I am not sure what it is supposed to do. Nevertheless, I always have a good use for a large square steel plate.

{% fig "IMG_0223.jpg", "X-Ray Machine from the garbage" %}
