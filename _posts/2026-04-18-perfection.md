...
- Can I remove anything else from it?
...
- [Plato's Theory of Forms](https://en.wikipedia.org/wiki/Theory_of_forms): the original metaphysical commitment to flawlessness as a realm above reality, with the physical world as a shadow of it.
- [Aristotle's Nicomachean Ethics](https://en.wikipedia.org/wiki/Nicomachean_Ethics): an alternative route, perfection as _telos_, a thing reaching its proper end. Much closer to the completion sense than the flawless one.
- [Leibniz, "the best of all possible worlds"](https://en.wikipedia.org/wiki/Best_of_all_possible_worlds): perfection reframed as optimization under constraint rather than absence of flaw.
- [Voltaire's _Candide_](https://en.wikipedia.org/wiki/Candide) (1759): the satirical response to Leibniz, and the source of _"le mieux est l'ennemi du bien"_ (the perfect is the enemy of the good).
- [Wabi-sabi](https://en.wikipedia.org/wiki/Wabi-sabi): a Japanese aesthetic rooted in imperfection, impermanence, and incompleteness. The inverse of the flawlessness model.
- [Karen Horney on the "tyranny of the should"](https://en.wikipedia.org/wiki/Karen_Horney): an early psychoanalytic account of neurotic perfectionism as self-attack.
- [Hewitt and Flett's Multidimensional Perfectionism Scale](<https://en.wikipedia.org/wiki/Perfectionism_(psychology)>): the foundational modern framework distinguishing self-oriented, other-oriented, and socially prescribed perfectionism.
- [Thomas Curran and Andrew Hill, "Perfectionism Is Increasing Over Time"](https://pubmed.ncbi.nlm.nih.gov/29283599/): a cross-temporal meta-analysis showing all three forms of perfectionism have risen in young adults since 1989.
