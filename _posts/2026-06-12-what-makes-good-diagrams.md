...
Blaming yourself comes easy, and I certainly do: maybe if I mastered the tools, or learned some obscure syntactic incantation, I could get the diagram I want, and quickly at that. But plenty of other engineers sit in the same rut.
...
The current tools force an impossible choice: (noisy) correctness or visual appeal (that will devolve into a lie).
